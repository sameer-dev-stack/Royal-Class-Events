...
"[project]/app/(public)/explore/[slug]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DynamicExplorePage() {
    ...
    const categoryInfo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CATEGORIES"].find((cat)=>cat.id === slug);
    const isCategory = !!categoryInfo;
    // 2. CHECK: If not a category, is it a valid Location?
    const { city, state, isValid } = !isCategory ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$location$2d$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseLocationSlug"])(slug) : {
        city: null,
        state: null,
        isValid: true
    };
    ...
    const { data: allEvents, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$convex$2d$query$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useConvexQuery"])(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].events.by_start_date);
    // 4. LOADING STATE
...
//# sourceMappingURL=_a8ff061c._.js.map