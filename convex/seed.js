...
Light refreshments will be provided. Limited seats available.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=WeWork+Dhaka",
    address: "WeWork, Gulshan 2, Dhaka",
    capacity: 50,
    ticketType: "free",
    coverImage:
...
Pizza and drinks provided!`,
    ...
    city: "Chittagong",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=GEC+Circle+Chittagong",
    address: "GEC Convention Center, Chittagong",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Food and beverages available for purchase at the venue.`,
    ...
    city: "Sylhet",
    state: "Sylhet",
    venue: "https://maps.google.com/?q=Sylhet+International+Stadium",
...
Chai stops included along the way!`,
    ...
    city: "Khulna",
    state: "Khulna",
    venue: "https://maps.google.com/?q=Khulna+University",
...
Laptop required. Course materials provided.`,
    ...
    city: "Barisal",
    state: "Barisal",
    venue: "https://maps.google.com/?q=Barisal+Park",
    address: "Bell's Park, Barisal",
    capacity: 30,
    ticketType: "free",
    coverImage:
...
Referee provided. Water and energy drinks available. Medical support on standby.`,
    ...
    city: "Rangpur",
    state: "Rangpur",
    venue: "https://maps.google.com/?q=Rangpur+Stadium",
    address: "Rangpur Stadium, Rangpur",
    capacity: 56,
    ticketType: "paid",
    ticketPrice: 350,
    coverImage:
...
Taste everything you cook! Great for health enthusiasts and curious foodies alike.`,
    ...
    city: "Mymensingh",
    state: "Mymensingh",
    venue: "https://maps.google.com/?q=Mymensingh+Town+Hall",
...
Yoga mats provided. Please wear comfortable clothing.`,
    ...
    city: "Comilla",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Comilla+Victoria+College",
    address: "Victoria College, Comilla",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 450,
    coverImage:
...
Energy drinks and snacks available. Exciting commentary and crowd interaction!`,
    ...
    city: "Narayanganj",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Narayanganj+Club",
    address: "Narayanganj Club, Narayanganj",
    capacity: 80,
    ticketType: "paid",
    ticketPrice: 200,
    coverImage:
...
Open to all genders. Q&A session and networking lunch included.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Dhaka+University",
...
Transport from Delhi available at additional cost.`,
    ...
    city: "Cox's Bazar",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Coxs+Bazar+Beach",
...
Refreshments provided. A great way to give back to nature while meeting like-minded people!`,
    ...
    city: "Kuakata",
    state: "Barisal",
    venue: "https://maps.google.com/?q=Kuakata+Beach",
    address: "Kuakata Beach, Barisal",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Code examples and cheat sheets provided.`,
    ...
    city: "Gazipur",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=IUT+Campus",
    address: "IUT Campus, Gazipur",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 999,
    coverImage:
...
Sleeping bags welcome. Food and drinks provided throughout.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=BICC+Dhaka",
    address: "Bangabandhu International Conference Center, Dhaka",
    capacity: 60,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Lunch and refreshments included. Bring your laptop!`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Gulshan+Club",
    address: "Gulshan Club, Dhaka",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 1499,
    coverImage:
...
Continental breakfast and unlimited coffee included!`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Westin+Dhaka",
    address: "The Westin, Gulshan 2, Dhaka",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 399,
    coverImage:
...
Snacks and beverages provided both days.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Drik+Gallery",
    address: "Drik Gallery, Panthapath, Dhaka",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2499,
    coverImage:
...
Perfect for team building and corporate bonding!`,
    ...
    address: "Sher-e-Bangla National Cricket Stadium, Mirpur, Dhaka",
    capacity: 180,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Healthy snacks and herbal teas included.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Yoga+Studio+Dhaka",
    address: "The Yoga Studio, Banani, Dhaka",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 899,
    coverImage:
  ...
  },
  {
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.app.goo.gl/PizzaDhaka",
    address: "Pizza Hut, Gulshan 1, Dhaka",
    capacity: 10,
    ticketType: "free",
    coverImage:
  ...
  },
  {
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.app.goo.gl/GoogleDhaka",
    address: "Google Office, Gulshan, Dhaka",
    capacity: 75,
    ticketType: "paid",
    ticketPrice: 250,
    coverImage:
