                ...
                <form onSubmit={form.handleSubmit(onFormSubmit as any)} className="p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="bg-zinc-900 border-zinc-800 min-h-[120px] rounded-xl focus:border-amber-500 leading-relaxed"
                    ...
                    <DialogFooter className="pt-4 border-t border-zinc-900 mt-4">
                        ...
                        <Button
                            ...
                            className="bg-amber-500 hover:bg-amber-600 text-black font-black px-10 rounded-xl h-12 shadow-xl shadow-amber-500/10 active:scale-95 transition-all"
                        >
