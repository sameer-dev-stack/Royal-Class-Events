            ...
            <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 text-white text-center">
                <div className="max-w-md space-y-6">
                    <div className="relative inline-block">
                        <Hammer className="w-20 h-20 text-amber-500 animate-bounce" />
                        <ShieldAlert className="w-8 h-8 text-black absolute -bottom-2 -right-2 bg-amber-500 rounded-full p-1" />
                    </div>
    ...
    return (
        <>
            ...
            {isMaintenance && isAdmin && (
                <div className="fixed top-0 left-0 w-full bg-amber-500 text-black py-1 px-4 text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 z-[9999]">
