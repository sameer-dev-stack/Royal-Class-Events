            ...
            <DialogContent className="bg-background border-border text-foreground max-w-md rounded-[2rem] overflow-hidden p-0 gap-0 shadow-2xl">
                ...
                <div className="p-8 pt-0 flex flex-col gap-4">
                    <Button
                        ...
                        variant="default"
                        size="lg"
                        className="w-full h-14 bg-gradient-to-r from-[#D4AF37] to-[#8C7326] hover:from-[#8C7326] hover:to-[#8C7326] text-black font-black text-lg rounded-2xl shadow-xl shadow-[#D4AF37]/10 transition-all active:scale-95"
                    >
                        {isSubmitting ? (
                            <>
