...
export default function CheckoutSidebar({ eventId, isOpen, onClose }) {
    ...
    return (
        <>
            <div className="flex flex-col h-full w-full bg-zinc-900 shadow-2xl">
                ...
                <div className="p-6 border-b border-zinc-800 flex items-center justify-between">
                    ...
                    {/* Only show close button on mobile usually, but keeping it helps */}
                    <button onClick={onClose} className="md:hidden p-2 hover:bg-zinc-800 rounded-full">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                ...
                <div className="p-6 bg-zinc-950 border-t border-zinc-800">
                    ...
                    <form id="checkout-form" onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                        <div>
                            <input
