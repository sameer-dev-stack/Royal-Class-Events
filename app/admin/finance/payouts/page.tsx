    ...
    return (
        <div className="space-y-8 text-white max-w-7xl mx-auto pb-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="bg-zinc-900/50 border-zinc-800 border-l-4 border-l-amber-500 shadow-2xl">
                                    ...
                                    <TableRow key={p._id} className="border-zinc-800/50 hover:bg-zinc-800/20 transition-all">
                                        ...
                                        <TableCell>
                                            <div className="flex flex-col gap-1">
                                                <span className="text-lg font-black text-amber-500 tracking-tighter italic">৳{p.amount.toLocaleString()}</span>
