                                ...
                                <TableCell className="py-5 pl-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-bold text-white group-hover:text-amber-500 transition-colors uppercase tracking-tight">{user.name}</span>
                                ...
                                <TableCell className="text-right pr-6">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end" className="w-56 bg-zinc-950 border-zinc-800 text-white shadow-2xl p-1 rounded-xl">
                                            ...
                                            >
                                                <Crown className="mr-3 h-4 w-4 text-amber-500" /> Grant Admin Access
                                            </DropdownMenuItem>
