            ...
            <div className="flex flex-col md:flex-row items-center gap-4 bg-zinc-900/30 p-4 rounded-2xl border border-zinc-800/50">
                <div className="relative flex-1 w-full">
                    ...
                    <Input
                        ...
                        className="bg-zinc-950/50 border-zinc-800 text-white pl-10 h-11 focus:ring-amber-500"
                        value={searchTerm}
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/20 overflow-hidden shadow-2xl">
                                ...
                                <TableCell className="py-5 pl-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-bold text-white text-base group-hover:text-amber-500 transition-colors">{event.title}</span>
                                ...
                                <TableCell>
                                    <div className="flex items-center gap-3">
                                        <Avatar className="w-8 h-8 ring-2 ring-zinc-800">
                                            ...
                                            <AvatarFallback className="bg-amber-500/10 text-amber-500 text-[10px]">{event.organizerName?.[0] || 'O'}</AvatarFallback>
                                        </Avatar>
                ...
                {filteredEvents.length === 0 && (
                    <div className="flex flex-col items-center justify-center p-20 text-center">
                        ...
                        <Button
                            variant="ghost"
                            className="text-amber-500 hover:text-amber-400 hover:bg-transparent text-sm mt-4 font-bold"
                            onClick={() => {
                                setSearchTerm("");
                                setStatusFilter("all");
                            }}
