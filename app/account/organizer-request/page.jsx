...
export default function OrganizerRequestPage() {
    ...
    if (user?.role === "organizer") {
        return (
            <Card className="bg-card/50 backdrop-blur-sm border-amber-500/20 shadow-2xl shadow-amber-500/5">
                <CardHeader className="text-center pb-2">
                    ...
                    <CardTitle className="text-2xl font-black italic tracking-tight">
                        You are an <span className="text-amber-500">ORGANIZER.</span>
                    </CardTitle>
                    <CardDescription>
                ...
                <Card className="bg-card/50 backdrop-blur-sm border-border shadow-xl">
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <div className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2 ${request.status === 'pending' ? 'bg-amber-500/10 text-amber-500 border border-amber-500/20' :
                    ...
                    <Card className="bg-card/50 backdrop-blur-sm border-border shadow-2xl relative overflow-hidden group">
                            ...
                            <form id="upgrade-form" onSubmit={handleSubmit} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        className="min-h-[150px] rounded-2xl bg-muted/50 focus:ring-amber-500/20 border-border"
                                        value={reason}
                        ...
                        <CardFooter className="flex flex-col gap-4">
                            <Button
                                ...
                                className="w-full h-12 bg-amber-500 hover:bg-amber-600 text-black font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg shadow-amber-500/10"
                            >
                                {isSubmitting ? (
                                    <>
