                    ...
                    >
                        <div className="relative w-full aspect-[4/5] max-w-sm mx-auto bg-zinc-900 rounded-[3rem] border border-white/10 p-4 shadow-3xl">
                            <div className="w-full h-full bg-black rounded-[2.5rem] overflow-hidden flex flex-col items-center justify-center p-8 space-y-8">
                                ...
                                <div className="w-full aspect-square rounded-3xl border-2 border-dashed border-amber-500/20 flex items-center justify-center relative">
                                    <Zap className="w-12 h-12 text-amber-500 animate-pulse" />
                                    <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-transparent via-amber-500 to-transparent animate-scan" />
                                </div>

                                <div className="text-center space-y-1">
                                    <p className="text-xs font-black text-amber-500 uppercase tracking-widest">Scanning...</p>
                                    <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-[0.2em]">892 / 1200 Guests In</p>
                                </div>
                            </div>

                            {/* Floating Glow */}
                            <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-amber-500/5 blur-[120px] rounded-full pointer-events-none" />
                        </div>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="p-12 md:p-20 rounded-[4rem] bg-zinc-900 border border-white/5 grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="text-center md:text-right space-y-4">
                            <div className="text-7xl md:text-9xl font-black italic text-amber-500 opacity-20">2.5M</div>
