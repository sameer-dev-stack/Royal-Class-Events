                    ...
                    <div className="grid md:grid-cols-3 gap-12 text-center">
                        {[
                            ...
                            <div key={i} className="space-y-2">
                                <p className="text-5xl md:text-7xl font-black text-amber-500 italic">{stat.val}</p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-20">
                        <div className="space-y-12">
                            ...
                            <div className="space-y-8">
                                {[
                                    ...
                                    >
                                        <div className="w-16 h-16 rounded-[1.5rem] bg-zinc-900 border border-white/5 flex items-center justify-center text-amber-500 group-hover:bg-amber-500 group-hover:text-black transition-all">
                        ...
                        <div className="relative">
                            <div className="relative z-10 p-1 bg-gradient-to-br from-amber-500/20 to-transparent rounded-[3rem]">
                                <div className="bg-zinc-900 rounded-[2.9rem] p-12 space-y-8 border border-white/5">
                                    ...
                                    <Button className="w-full h-14 rounded-2xl bg-amber-500 hover:bg-amber-600 text-black font-black uppercase tracking-widest text-xs">
                                        Unlock Full Suite
                                    </Button>
                                </div>
                            </div>
