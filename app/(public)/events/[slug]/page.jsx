            ...
            <div className="space-y-10">
                ...
                <div className="group bg-card border border-border rounded-3xl overflow-hidden hover:border-amber-500/30 transition-colors">
                  <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
                    <div className="space-y-2">
                      ...
                      <p className="text-2xl font-bold text-foreground">{event.venue || "Private Location"}</p>
                      <p className="text-gray-400">{event.address || "Address visible to ticket holders"}, {event.city}</p>
                    </div>
                    {event.venue && (
                      <Button variant="outline" className="border-white/10 hover:bg-white/10 text-white shrink-0" asChild>
                        <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(event.venue + " " + event.city)}`} target="_blank" rel="noopener noreferrer">
              ...
              <section className="space-y-4">
                ...
                <div className="flex items-center gap-5 bg-card/50 p-6 rounded-3xl border border-border backdrop-blur-sm">
                  ...
                  <div>
                    <p className="font-bold text-xl text-white mb-1">{event.organizerName}</p>
              ...
              <CardContent className="p-8 space-y-8">
                  ...
                  <div className="flex items-baseline gap-2">
                    {event.ticketType === "free" ? (
                      ...
                      <>
                        ...
                        <span className="text-5xl font-bold text-white tracking-tight">{event.ticketPrice}</span>
                      </>
                    )}
                  </div>
                  {event.ticketType === "paid" && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-black/40 p-4 rounded-2xl border border-white/5 text-center">
                    ...
                    <p className="text-xl font-bold text-amber-500">{event.registrationCount}</p>
                  </div>
                </div>
